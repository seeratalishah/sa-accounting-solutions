...
export const whatWeExpectData = [
  {
    id: 1,
    icon: PiUsersFill,
    title: "You will meet our team",
    desc: "Relationships matter. You will meet a dedicated team of professionals who will support you and your business.",
  },
  {
    id: 2,
    icon: HiShieldCheck,
    title: "You'll discover how easy it can be.",
    desc: "We handle all the setup and assist you in automating your processes.",
  },
  {
    id: 3,
    icon: GiFreedomDove,
    title: "You'll experience the freedom.",
    desc: "All those manual processes, gone! We'll help you eliminate mundane tasks so you can focus on what truly matters.",
  },
  {
    id: 4,
    icon: GrSettingsOption,
    title: "You'll see results.",
    desc: "We'll give you your time back by automating your repetitive tasks.",
  },
  {
    id: 5,
    icon: PiEmptyBold,
    title: "You'll have empty pockets.",
